...
public class AssociadoServiceImpl implements AssociadoService{
	...
	public AssociadoDTO update(Optional<Associado> associadoOptional, AssociadoFormDTO form) {
		Associado associado = associadoOptional.get();
		if(form.getNome() != null)associado.setNome(form.getNome());
		if(form.getCargoPolitico() != null)associado.setCargoPolitico(form.getCargoPolitico());
		if(form.getDataNascimento() != null)associado.setDataNascimento(form.getDataNascimento());
		if(form.getSexo() != null)associado.setSexo(form.getSexo());
